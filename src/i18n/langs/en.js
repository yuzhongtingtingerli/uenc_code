...
module.exports = {
  ...
  index: {
    ...
    bannerContent: 'Economics Fast  A blockchain network that can be integrated into any computer in the world',
    ...
    EFSTitle: 'Economics Fast Safe',
    EFSContent: 'Simple and efficient algorithm to achieve low-cost intervention in circulation, self invented DPOW consensus mechanism to make block delivery and verification faster, UTXO technology ensures the security and credibility of UENC user chain transactions.',
